...
const login = () => {
    ...
    const formik = useFormik({
        initialValues: {
            email: 'diegoale20@outlook.es',
            password: '123456'
        },
        validationSchema: Yup.object({
            email: Yup.string().email('El email no es valido!').required('El email es requerido!'),
            password: Yup.string().required('El password no es obligatorio!')
        }),
        onSubmit: async (valores) => {
            ...
            try {
                ...
                await setTimeout(() => setMensaje(null), 2000);
                    ...
                    <div className="w-full max-w-sm">
                        <form className="bg-white rounded shadow-md px-8 pt-6 pb-8  mb-4" onSubmit={formik.handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="password" type="password" placeholder="Password" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.password} />
